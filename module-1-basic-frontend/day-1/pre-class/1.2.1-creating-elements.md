# 1.2.1: DOM Review - Creating Elements
...
The following example demonstrates how to create an add a DOM element to a page. We use `const` to declare `coolParagraph` because we do not expect to reassign `coolParagraph`. See [1.2: ES6](../../../Module1/0-language-and-tooling/0.2-es6/0.2.1-es6-basics.md#const-for-primitive-values-that-dont-change) to review `const`.
...
![](../../../old\_bootcamp\_docs/.gitbook/assets/screen-shot-2020-09-29-at-6.52.58-pm.png)
