...
You should already have Node installed. Check by typing the following in the terminal, which will check the Node version. If you've not installed node, please [click here](../../../course-logistics/required-hardware-and-software.md#install-node.js) and install accordingly.
