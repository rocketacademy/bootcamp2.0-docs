...
![Computers send HTTP requests to servers over Internet, and servers may respond with HTTP responses.](../../../Module1/day15/.gitbook/assets/http-server-node.jpg)
...
![Retrieving data over 4G is like a round-trip to Saturn compared with retrieving data locally.](../../../Module1/day15/.gitbook/assets/my-document-2-%20\(1\).jpg)
