...
Build on your work in the High Card repo from [Module 1.5: High Card DOM](../../../Module1/day2/1.3-high-card-dom.md). Remember to work on a forked copy of the [Coding Bootcamp High Card repo](https://github.com/rocketacademy/high-card-bootcamp), and submit a Pull Request once done.

## Base

Complete the entire High Card game as described in [Module 1.5: High Card DOM](../../../Module1/day2/1.3-high-card-dom.md).
