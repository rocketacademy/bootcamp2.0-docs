...
No need to worry for now how JavaScript manages to keep track and manage these values for use in an object or array. We'll cover the topic when we learn about [Hash Tables](../../../algos/day7/a.5.2-hash-tables.md).
...
ES6 spread operator will make a copy of every value in the array into a new array. [See: 0.2.3.](../../supplemental-material/0.2.3-es6-destructuring-spread-operators.md#example-make-shallow-copy-of-array)
