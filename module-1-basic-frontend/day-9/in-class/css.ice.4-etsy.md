...
Given the limited time for this exercise, begin by coding the top and bottom of the page before adding each middle section. Refer to the [cheatsheet](https://bootcamp.rocketacademy.co/css/css-1-basic-css#exercise-tips-cheatsheet) to make the page easier to code.
