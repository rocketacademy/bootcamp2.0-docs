...
![Our Express app will have this architecture.](../../../Module2/day1/.gitbook/assets/express-4.jpg)
...
This module is an optimization and evolution of the [Noodle Recipe Website](../../../Module2/day1/1-frontend-basics/1.poce-post-class-exercises/1.poce.1-noodles.md) and the [Noodle Recipe with FIle Server](../../../Module2/day1/2-backend-basics/2.poce-post-class-exercises/2.poce.5-responsive-noodle-site.md#deploy-to-ec2)- how do we display on the internet an interlinked set of recipes, such that:
