...
1. If you haven't already, install Thunder Client from [0.7: Thunder Client](../../../Module2/0-language-and-tooling/0.7-postman.md).
...
2. Remember to include the [middleware for Express to populate `request.body`](../../../Module2/day3/3.1-express-js/3.1.3-handling-post-requests.md#receive-post-requests-in-express).
...
1.  Create a form on the sightings list page that sends a GET request with the same sort query parameters from [3.ICE.1: Bigfoot.](../../../Module2/day3/inclass/3.ice.1-bigfoot.md#sort-by) The generated request URLs might look like the following.
...
3.  Add a similar dropdown for other sort options from [3.ICE.2: Bigfoot EJS](../../../Module2/day3/inclass/3.ice.2-bigfoot-ejs.md#sort-by). These might produce the following URLs.
