...
![The data in the database is stored separately from the application code.](../../../old\_bootcamp\_docs/.gitbook/assets/sql-database.jpg)
...
![The PostgreSQL server is typically on a separate machine from the web applications that access it.](../../../old\_bootcamp\_docs/.gitbook/assets/postgres.jpg)
