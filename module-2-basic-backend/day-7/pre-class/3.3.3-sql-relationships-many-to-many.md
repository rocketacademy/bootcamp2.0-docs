...
In [3.4.2: SQL Relationships (One to Many)](../../../Module2/day7/preclass/3.3.2-sql-relationships-one-to-many.md) we learned how to associate 2 tables to each other using foreign keys. This created a relationship in which one row in a table (e.g. `categories`) could be referenced multiple times in another table (e.g. `recipes`).

![Recap of a one-to-many SQL relationship](../../../old\_bootcamp\_docs/.gitbook/assets/one-to-many.jpg)
...
![Sample DB Schema for Recipe App with Many-to-Many Relationship](../../../old\_bootcamp\_docs/.gitbook/assets/many-many.jpg)
