...
Async/await is a powerful tool to simplify our code, especially when performing DB queries with Sequelize. The following code builds on the migration and model setup from [Module 4.1.2: Sequelize One-to-Many Relationships](../../../Module3/day2/preclass/4.1.2-sequelize-one-to-many-relationships.md).
